  ...
  const availableDepartments = useMemo(() => {
    ...
    if (permissions.canViewAll) {
      ...
      return departments.filter((dept) =>
        permissions.allowedDepartments.includes(dept.id),
      );
    }
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Advanced analytics and performance insights for ITG SharePoint tasks with trends and comparisons"
        />
        <meta
          name="keywords"
          content="ITG, analytics, trends, performance, insights, comparisons, SharePoint"
        />
      </Helmet>
      ...
      <div className={styles.analytics}>
        ...
        <div className={styles.content}>
          {loading ? <AnalyticsSkeleton /> : renderTabContent()}
        </div>
      </div>
    </>
  );
