...
export const CONFIG = {
  ...
  SHAREPOINT: {
    SITE_URL: import.meta.env.VITE_SHAREPOINT_URL || window.location.origin,
    LIST_CONFIG: {
      infra: {
        name: 'si_tasklist',
...
export const isSharePoint = CONFIG.DEPLOYMENT.TYPE === 'sharepoint';
export const isStandalone = CONFIG.DEPLOYMENT.TYPE === 'standalone';