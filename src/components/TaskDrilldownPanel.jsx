              ...
              <div key={t.Id} className={styles.row}>
                ...
                {expanded && (
                  <div className={styles.expandArea}>
                    {t.Description && <div className={styles.block}>{stripHtml(t.Description)}</div>}
                    <div className={styles.grid}>
                      <div className={styles.kv}><span>Assignee</span><div className={styles.assigneeContainer}><AssigneeAvatars assignees={t.AssignedTo} /></div></div>
                      ...
                      <div className={styles.kv}><span>Remarks</span><strong>{stripHtml(t.Remarks) || '—'}</strong></div>
                    </div>
                  </div>
                )}
              </div>
