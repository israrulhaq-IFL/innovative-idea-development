...
const UserInfo = ({ user, permissions }) => {
  ...
  const viewDepts = (permissions.allowedDepartments || []).map((d) => deptLabels[d] || d);
  const editDepts = (permissions.canEditDepartments || []).map((d) => deptLabels[d] || d);
    ...
    <div className={styles.userInfo}>
      ...
      <div className={styles.userDetails}>
        ...
        <div className={styles.categoryAndPermissions}>
          {categoryLabel && (
            <span className={styles.userCategory}>
              {categoryLabel}
            </span>
          )}
          {showPermissions && (
